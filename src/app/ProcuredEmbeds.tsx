    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="border border-gray-300 rounded-lg p-6">
          <h3 className="text-lg font-semibold mb-3 text-blue-600">1. Standard Popup</h3>
  ...
  <iframe id="procured-iframe"
    ...
    style="border:none">
        ...
        <div className="border border-gray-300 rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">Request with measurement tools</p>
...
{`<button onClick="openProcuredForm();">
  Get Quote
        ...
        <div className="border border-gray-300 rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">Measurements in new tab</p>
      ...
      <div className="text-center mb-6">
        <label className="inline-flex items-center">
          <input
            ...
            className="mr-2"
          />
          <span className="text-gray-700">Show metrics on forms (affects embeds 1, 4, and 5)</span>
        </label>
      </div>
